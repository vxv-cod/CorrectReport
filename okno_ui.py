...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(450, 192)
        Form.setMinimumSize(QtCore.QSize(0, 192))
        Form.setMaximumSize(QtCore.QSize(16777215, 192))
        icon = QtGui.QIcon()
...
"}")
        ...
        self.plainTextEdit_2.setMinimumSize(QtCore.QSize(0, 40))
    ...
    def retranslateUi(self, Form):
        ...
        self.plainTextEdit.setPlainText(_translate("Form", "file:///C:/vxvproj/tnnc-Excel/CorrectReportApp/CorrectReport/Сметы"))
        self.plainTextEdit.setPlaceholderText(_translate("Form", "Перетащите сюда папку для сохранения файлов"))
        self.pushButton.setText(_translate("Form", "Start"))
        self.pushButton.setShortcut(_translate("Form", "Return"))
        self.plainTextEdit_2.setPlaceholderText(_translate("Form", "Перетащите сюда папку с подписями в формате *.jpg"))
